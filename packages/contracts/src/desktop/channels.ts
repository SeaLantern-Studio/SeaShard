export const desktopChannels = {
  ...
  hostConnectionsRejectControl: "seashard.host-connections.reject-control",
  hostConnectionsAcknowledgeConflict: "seashard.host-connections.acknowledge-conflict",
  desktopUpdateSnapshot: "seashard.desktop-update.snapshot",
  desktopUpdateCheck: "seashard.desktop-update.check",
  desktopUpdateApply: "seashard.desktop-update.apply",
  desktopUpdateFinish: "seashard.desktop-update.finish",
  desktopUpdateExitDecisionRequired: "seashard.desktop-update.exit-decision-required",
  desktopUpdateChanged: "seashard.desktop-update.changed",
  ...
  serverInstancesPlugins: "seashard.server-instances.plugins",
  serverInstancesSetPluginDisabled: "seashard.server-instances.set-plugin-disabled",
  serverInstancesDeletePlugin: "seashard.server-instances.delete-plugin",
  ...
  serverRuntimeWaitStartupSettled: "seashard.server-runtime.wait-startup-settled",
  serverRuntimeWaitStopped: "seashard.server-runtime.wait-stopped",
